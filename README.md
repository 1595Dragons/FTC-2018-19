## Welcome!
This GitHub repository contains the source code that is used to build an Android app to control a *FIRST* Tech Challenge competition robot.  To use this SDK, clone the entire project to your local computer using [GitHub Desktop][1].
